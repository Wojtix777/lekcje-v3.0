...
<body>
    ...
    <header>
        ...
        <p>Finished by Wojciech Szyndela. This was WAYYYYYYY more enjoyable than just dry HTML or CSS, which just <b><i>bored</i></b> me to death.</br>Matter of fact, this website had me playing around with it a bit, as you can see. What can I say? I loved the exercise.</p>
    </header>
    <hr>
    <main>
        <!-- p1 -->
...
<!--             <sub>Redirect form into <mark>exercise/p1.php</mark>, with method <mark>POST</mark> and display variables from <mark>$_POST[]</mark>.</sub>
            ...
            <label for="terms">
                ...
                Do you agree to <a href="terms.php">terms and conditions</a>?
            </label>
            <span>
                <button>Send</button>
...
<!--             <sub>Redirect form into <mark>exercise/p3.php</mark>, with correct method.</sub>
            ...
            <span>
                <label for="Men">
                    Men <input type="radio" name="gender" value="Man">
                </label>
                <label for="Women">
                    Women <input type="radio" name="gender" value="Woman">
                </label>
                <label for="Other">
                    Other <input type="radio" name="gender" value="Other">
                </label>
                <label for="Rather not say">
                    Rather not say <input type="radio" name="gender" value="Rather not say">
                </label>
            </span>
            <span>
                <button>Send</button>
...
<!--             <sub>Validate: name (min 3 chars), surname (required), checkbox must be checked.</sub>
            ...
            <input type="text" placeholder="Surname here" name="surname">
            <label for="terms">
        ...
        <!-- p5 -->
        <form action='exercise/p5.php' method='POST' id="p5">
...
<!--             <sub>Redirect form into <mark>exercise/p5.php</mark>, with method correct method.</sub>
        ...
        <!-- p6 -->
        <form action='exercise/p6.php' method='POST' id="p6">
...
<!--            <sub>Redirect form into <mark>exercise/p6.php</mark>, with method correct method.</sub> -->
                ...
                <select name="user_id" id="user_id">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $first_name = $row['first_name'];
                            ...
                            echo "<option value='null'>No users in database.</option>";
                        };
                    ?>
                </select>
            </label>
        ...
        <!-- p7 -->
        <form action="index.php#p7" method="GET" id="p7">
...
<!--             <sub>Redirect form into <mark>exercise/p7.php</mark> and display, with method <mark>GET</mark>.</sub>
            ...
            <?php
            include("exercise/p7.php");
            ?>
        </form>
        <!-- p8 -->
        <form action="exercise/p8.php" method="POST" id="p8">
